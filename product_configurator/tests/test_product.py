...
class TestProduct(common.TestProductConfiguratorCommon):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.product_tmpl_id = cls.ProductTemplate.create(
            {
                "name": "Test Configuration",
                "config_ok": True,
                "type": "consu",
                "categ_id": cls.product_category_5.id,
            }
        )
    ...
    def _get_product_id(self):
        ...
        return self.cfg_tmpl.product_variant_ids
    ...
    def test_04_unlink(self):
        ...
        product_config_wizard.action_next_step()
        config_session_id = self.ProductConfigSession.search(
            [("product_tmpl_id", "=", self.product_tmpl_id.id)]
        )
    ...
    def test_05_check_default_values(self):
        self.attr_line_fuel.default_val = (self.value_gasoline.id,)
        self.attr_line_engine.default_val = self.value_218d.id
        with self.assertRaises(ValidationError):
            self.cfg_tmpl._check_default_values()
    ...
    def test_07_get_mako_tmpl_name(self):
        ...
        self.cfg_tmpl.write({"mako_tmpl_name": "Test Configuration Product"})
        mako_tmpl_vals = product_product._get_mako_tmpl_name()
        self.assertEqual(
            self.cfg_tmpl.mako_tmpl_name,
            mako_tmpl_vals,
    ...
    def test_10_reconfigure_product(self):
        ...
        # pta_val_ids = self.ProductAttributeValue.search(
        #     [
        #         ("product_tmpl_id", "=", self.product_tmpl_id.id),
    ...
    def test_11_compute_product_weight_extra(self):
        ...
        product_product = self._get_product_id()
        productAttPrice = self.ProductAttributeValue.search(
            [
