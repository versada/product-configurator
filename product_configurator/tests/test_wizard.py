...
class ConfigurationWizard(common.TestProductConfiguratorCommon):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
    ...
    def test_12_fields_get(self):
        ...
        product_config_wizard_1 = self.ProductConfigurator.create(
            {
                "product_tmpl_id": self.cfg_tmpl.id,
            }
        )
    ...
    def test_15_read(self):
        ...
        self.ProductConfigurator.action_next_step()
        product_config_wizard_2 = self.ProductConfigurator.create(
            {
                "product_tmpl_id": product_tmpl.id,
            }
        )
