...
class ProductConfigurator(models.TransientModel):
    ...
    def _prefixes(self):
        ...
        Dictionary contains all dynamic field prefixes used to generate
    ...
    def get_state_selection(self):
        """Get the states of the wizard.

        Use standard values and optional configuration steps set on
        the product.template via config_step_line_ids.
        """
    ...
    def onchange(self, values, field_name, field_onchange):
        """Override the onchange wrapper.

        Return domains to dynamic fields as onchange isn't
        triggered for non-db fields.
        """
    ...
    def add_dynamic_fields(self, res, dynamic_fields, wiz):
        ...
        View is using the dynamically generated fields in fields_get().
        """
        field_prefix = self._prefixes.get("field_prefix")
        custom_field_prefix = self._prefixes.get("custom_field_prefix")
    ...
    def create(self, vals_list):
        """Set the configuration values of the product_id if given (if any).
    ...
    def write(self, vals):
        """Prevent database storage of dynamic fields.

        Instead write values to database persistent value_ids field.
        """
    ...
    def action_next_step(self):
        ...
        This usually implies the next configuration step (if any) defined
    ...
    def action_previous_step(self):
        ...
        This usually implies the next configuration step (if any)
        defined via the config_step_line_ids on the product.template.
        """
        wizard_action = self.with_context(
